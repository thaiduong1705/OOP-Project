...
ALTER TABLE TAIKHOAN ADD CONSTRAINT FK_ChucVu_TK FOREIGN KEY (MaChucVu) REFERENCES CHUCVU(MaChucVu)
ALTER TABLE TAIKHOAN ADD CONSTRAINT FK_MaNhanVien_TK FOREIGN KEY (MaNhanVien) REFERENCES NHANVIEN(MaNhanVien)
